...
app.get('/statement/date', verifiryIfExistsAccountCPF, (request, response) => {
    const { customer} = request;    
...
app.put('/account', verifiryIfExistsAccountCPF, (request, response) => {
...
app.get('/account', verifiryIfExistsAccountCPF, (request, response) => {
    const { customer } = request;

    return response.json(customer);
});

app.delete('/account', verifiryIfExistsAccountCPF, (request, response) => {
    const { customer } = request;
...
app.get('/balance', verifiryIfExistsAccountCPF, (request, response) => {
    const { customer } = request;
